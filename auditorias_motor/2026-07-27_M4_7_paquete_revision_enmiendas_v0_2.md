...
- `M4-OWNER-DECISION-001`: Aceptar provisionalmente las 26 reglas nucleares y el operador auxiliar corregidos en v0.2.
...
- `M4-OWNER-P1-ORDER-TYPES`: Aplicar solo entradas MARKET en el alcance inmediato.
...
- `M4-OWNER-P2-PRICE-REFERENCES`: Definir las referencias de precio para entrada, TP y SL.
...
- `M4-OWNER-P3-LIQUIDATION-SEMANTICS`: Definir la liquidacion cuando no existe estado completo de cuenta.
...
- `M4-OWNER-P4-EXPIRY-PAYOFF`: Definir el cierre y payoff de la rama expiry.
...
SHA-256 del payload canonico del paquete: `d572a87dc5276b15928bcd61506885919f6fbb120f7bdf6dce0795f07cdec3c7`.
