...
APP_VERSION = "app-v0.27.1-limit-placement-fix"
APP_SEMVER = "0.27.1"
...
DATA_CONTRACT_VERSION = "data-contract-v0.20-limit-lifecycle"
...
PROSPECTIVE_RUNTIME_VERSION = "tp-sl-rule-library-runtime-v0.16"
