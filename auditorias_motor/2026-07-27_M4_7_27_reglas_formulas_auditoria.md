# M4.7 - Las 27 reglas y sus formulas
...
Estas son las 27 fichas formales propuestas para el nucleo P0.
...
| 5 | `M4-RULE-BARRIER-REACHABILITY-001` | M4.2 | `z_TP=d_TP/sigma_prev(H)<br>z_SL=d_SL/sigma_prev(H)<br>b=ln(d_TP/d_SL)` |
...
| 8 | `M4-RULE-PATH-STRUCTURE-001` | M4.3 | `D_W=sum(r_i)=ln(C_end/C_start)<br>TV_W=sum(abs(r_i))<br>E_W=abs(D_W)/TV_W<br>SE_W=D_W/TV_W; if TV_W=0, observed flat path gives SE_W=0` |
...
| 14 | `M4-RULE-OPEN-INTEREST-CHANGE-001` | M4.4 | `dOI_H=ln(OI_t/OI_(t-H))` |
...
| 18 | `M4-RULE-FUNDING-STATE-001` | M4.4 | `f_last_hour=lastFundingRate/fundingIntervalHours<br>L_prev(H)=sum(f_j where t-H<fundingTime_j<=t)<br>L_prev_hour(H)=L_prev(H)/H_hours<br>N_schedule=count configured event times within future H` |
| 19 | `M4-RULE-DERIVATIVES-CONTEXT-001` | M4.4 | `DC_H=(ATI_H,dOI_H,b_mid,f_last_hour)` |
...
| 21 | `M4-RULE-DEPTH-SWEEP-001` | M4.5 | `buy consume asks; sell consume bids<br>VWAP=sum(price_i*filled_qty_i)/requested_qty<br>D=+1 buy, -1 sell<br>IS_fraction=D*(VWAP-arrival_mid)/arrival_mid<br>fill_ratio=filled_qty/requested_qty` |
| 22 | `M4-RULE-FEE-SCENARIOS-001` | M4.5 | `fee(role)=notional*commission_rate(role)<br>lower=min(fee(role)); upper=max(fee(role))<br>exact iff one execution role is known` |
...
- [BINANCE-USDM-KLINES](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/market-data): Supported kline intervals and timestamp fields.
...
- `M2-SEMANTIC-CONTRACT`: Approved side-symmetric geometry.
...
- [ANDERSEN-BOLLERSLEV-DIEBOLD-LABYS-2003](https://doi.org/10.1111/1468-0262.00418): High-frequency return inputs for realized volatility.
- [BINANCE-USDM-KLINES](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/market-data): Close price and close timestamp semantics.
...
- [ANDERSEN-BOLLERSLEV-DIEBOLD-LABYS-2003](https://doi.org/10.1111/1468-0262.00418): Sum-of-squared high-frequency returns measures RV.
- [XIE-ET-AL-2019-BITCOIN-RV](https://doi.org/10.3390/econometrics7030040): Bitcoin RV can be forecast, but competing model specifications matter.
...
## 5. M4-RULE-BARRIER-REACHABILITY-001

**Nombre:** Distancia TP/SL normalizada por volatilidad
...
- `M2-SEMANTIC-CONTRACT`: Mandatory z_TP and z_SL geometry.
- [POETZELBERGER-WANG-2001](https://doi.org/10.1239/jap/996986650): Actual crossing probability requires a specified path process and boundary treatment.
...
- `M2-SEMANTIC-CONTRACT`: No-entry and post-entry expiry are separate outcomes.
- `M3-DATA-CONTRACTS`: Plan trigger, analysis price and timestamps are pre-trade data.
...
- [NIST-SINGLE-EXPONENTIAL-SMOOTHING](https://www.itl.nist.gov/div898/handbook/pmc/section4/pmc431.htm): Recursive exponential smoothing and initialization.
...
TV_W=sum(abs(r_i))
E_W=abs(D_W)/TV_W
SE_W=D_W/TV_W; if TV_W=0, observed flat path gives SE_W=0
```
...
- [MOSKOWITZ-OOI-PEDERSEN-2012](https://doi.org/10.1016/j.jfineco.2011.11.003): Past return sign showed momentum at monthly horizons in traditional futures.
- [HUDSON-URQUHART-2021](https://doi.org/10.1007/s10479-019-03357-1): Crypto technical-rule performance varied by asset and failed OOS for Bitcoin in their selected test.
...
- [OSLER-2000-SUPPORT-RESISTANCE](https://www.newyorkfed.org/medialibrary/media/research/epr/00v06n2/0007osle.pdf): Published FX levels predicted some intraday trend interruptions with heterogeneous performance.
- [CURCIO-ET-AL-2014-PRICE-MEMORY](https://doi.org/10.1038/srep04487): Local extrema, bounce count and time scale can be studied as price-memory candidates.
...
- [HAMILTON-1989-REGIME-SWITCHING](https://doi.org/10.2307/1912559): Regimes require a specified estimated state model.
- [CORSI-2009-HAR-RV](https://doi.org/10.1093/jjfinec/nbp001): Volatility contains heterogeneous temporal components.
...
- [CORSI-2009-HAR-RV](https://doi.org/10.1093/jjfinec/nbp001): Different horizons can carry distinct temporal information.
- [HUDSON-URQUHART-2021](https://doi.org/10.1007/s10479-019-03357-1): Technical-rule effects are asset and sample dependent.
...
- [HAMILTON-1989-REGIME-SWITCHING](https://doi.org/10.2307/1912559): A genuine latent regime requires model estimation; this rule therefore remains an observed state vector.
...
- {"m3_data_contract_ids":["M3-DATA-005","M3-DATA-007","M3-DATA-015"],"provider":"Binance USD-M and Binance Spot"}

### Tiempo, unidades y frescura

- {"horizons":["intraday_short","intraday_wide","short_swing"],"markets":["Binance USD-M perpetual","Binance Spot"],"normalized_units":"log_ratio_or_dimensionless_ratio","symbols":["BTCUSDT","ETHUSDT","SOLUSDT","BNBUSDT","XRPUSDT","INJUSDT"],"time_rule":"M3-compliant data only; exact windows end at or before analysis_at and cross-venue skew is bounded"}
...
- [BINANCE-USD-M-MARKET-DATA](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/market-data): Trade side, price, quantity and taker volumes.
- [CONT-KUKANOV-STOIKOV-2014](https://doi.org/10.1093/jjfinec/nbt003): Trade imbalance is weaker than full order-book event imbalance in the studied equity data.
...
- {"m3_data_contract_ids":["M3-DATA-013","M3-DATA-014"],"provider":"Binance USD-M and Binance Spot"}
...
- [BINANCE-USD-M-MARKET-DATA](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/market-data): Current and historical total open interest.
- [HONG-YOGO-2012](https://doi.org/10.1016/j.jfineco.2011.05.008): OI changes carried information in traditional futures samples.
...
- {"m3_data_contract_ids":["M3-DATA-005","M3-DATA-013","M3-DATA-014"],"provider":"Binance USD-M and Binance Spot"}
...
- [HONG-YOGO-2012](https://doi.org/10.1016/j.jfineco.2011.05.008): OI may contain information beyond futures price.
- `M4.3-STRUCTURE`: D_H is the exact-H log price displacement.
...
Measure synchronized midpoint and executable quote ratios between Binance Spot and USD-M perpetual.
...
- [BINANCE-SPOT-MARKET-DATA](https://developers.binance.com/en/docs/catalog/core-trading-spot-trading/api/rest-api/market): Spot best bid and ask.
- [BAUR-DIMPFL-2019](https://doi.org/10.1002/fut.22004): Spot led futures in their Bitcoin sample.
- [FRINO-ET-AL-2025](https://doi.org/10.1002/fut.22560): Futures generally led spot in a later sample, with daily variation.
...
- {"m3_data_contract_ids":["M3-DATA-010"],"provider":"Binance USD-M and Binance Spot"}
...
- [BINANCE-USD-M-MARKET-DATA](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/market-data): Mark price, index price and provider time.
- [HE-MANELA-ROSS-VON-WACHTER-2022](https://arxiv.org/abs/2212.06888): Perpetual prices can deviate from spot anchors.
...
- {"m3_data_contract_ids":["M3-DATA-010","M3-DATA-011","M3-DATA-012"],"provider":"Binance USD-M and Binance Spot"}
...
```text
f_last_hour=lastFundingRate/fundingIntervalHours
...
- [BINANCE-USD-M-MARKET-DATA](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/market-data): Funding rate, funding time, next time and adjusted interval configuration.
- [HE-MANELA-ROSS-VON-WACHTER-2022](https://arxiv.org/abs/2212.06888): Funding is an anchoring cash-flow mechanism.
...
- {"m3_data_contract_ids":["M3-DATA-007","M3-DATA-008","M3-DATA-010","M3-DATA-012","M3-DATA-014","M3-DATA-016","M3-DATA-017"],"provider":"Binance USD-M and Binance Spot"}
...
```text
DC_H=(ATI_H,dOI_H,b_mid,f_last_hour)
```
...
- `M4.3-STRUCTURE`: Interaction vectors reference atomic components without adding them as separate evidence.
- `M3-DATA-CONTRACTS`: Every component has a separate data contract.
...
- [BINANCE-USD-M-MARKET-DATA](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/market-data): Bid y ask son observables oficiales del mercado.
- [FINRA-INSTITUTIONAL-ORDER-HANDLING-2019](https://www.finra.org/sites/default/files/OCE_WP_jan2019.pdf): El midpoint de llegada es referencia de ejecucion.
...
Estimacion del barrido visible actual solo si fill_ratio=1.
...
VWAP=sum(price_i*filled_qty_i)/requested_qty
D=+1 buy, -1 sell
IS_fraction=D*(VWAP-arrival_mid)/arrival_mid
...
- [FINRA-INSTITUTIONAL-ORDER-HANDLING-2019](https://www.finra.org/sites/default/files/OCE_WP_jan2019.pdf): VWAP firmado contra midpoint mide shortfall.
- [ALMGREN-CHRISS-2001](https://doi.org/10.21314/JOR.2001.041): Coste e impacto pertenecen al problema de ejecucion.
...
Coste exacto por rol conocido o intervalo de escenarios.
...
exact iff one execution role is known
```
...
- [BINANCE-USD-M-ACCOUNT](https://developers.binance.com/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/account): La cuenta expone tasas maker, taker y RPI.
...
- [HE-MANELA-ROSS-VON-WACHTER-2022](https://arxiv.org/abs/2212.06888): Funding positivo transfiere de largos a cortos.
- `M4.4-DERIVATIVES`: La ultima tasa observada no es una tasa futura.
...
- `M2-SEMANTICS`: La geometria valida depende de la direccion.
- [INVESTOR-GOV-LEVERAGED-INVESTING](https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins/leveraged-investing-strategies-know-risks-using-these-advanced-investment-tools): El apalancamiento amplifica ganancias y perdidas.
- `M3-DATA-CONTRACTS`: Margen y apalancamiento pertenecen al plan de usuario.
...
- `M2-SEMANTICS`: Cada rama pre-trade es un resultado distinto.
- [FINRA-INSTITUTIONAL-ORDER-HANDLING-2019](https://www.finra.org/sites/default/files/OCE_WP_jan2019.pdf): La ejecucion aporta coste y falta de fill observables.
...
- `M2-SEMANTICS`: Las probabilidades y payoffs deben compartir resultados.
...
- `M3-DATA-CONTRACTS`: Ausencia y degradacion deben declararse por dato.
...
SHA-256: `474758f48c96a9b923332d94e10e70b91b4568b9d5ee6b05cfd32465d3092e53`.
