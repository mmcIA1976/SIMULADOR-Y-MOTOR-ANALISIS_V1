...
- Basis: tres razones logaritmicas de quotes sincronizados.
- Prima mark-index: `ln(markPrice/indexPrice)`.
- Funding: ultima tasa por hora y carga realizada del H anterior.
- Contexto: `(ATI_H,dOI_H,b_mid,f_last_hour)` sin score.
...
SHA-256: `8c764a9b36d74ac9a4dbc62416d0ac7b921112641d9ab7e37008af0996ef9736`.
